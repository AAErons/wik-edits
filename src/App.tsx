							...
							<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
								...
								<article className="rounded-xl border border-zinc-800 bg-zinc-950/70 p-6 shadow-xl">
									<header className="mb-4 flex items-center gap-3">
										<div className="h-12 w-12 rounded-full bg-gradient-to-br from-brand/60 to-purple-700/30 flex items-center justify-center text-lg font-bold">S</div>
										<div>
								...
								<article className="rounded-xl border border-zinc-800 bg-zinc-950/70 p-6 shadow-xl">
									<header className="mb-4 flex items-center gap-3">
										<div className="h-12 w-12 rounded-full bg-gradient-to-br from-blue-500/60 to-indigo-700/30 flex items-center justify-center text-lg font-bold">V</div>
										<div>
											<div className="flex items-center gap-2">
			...
			{isMobileMenuOpen && (
				<div className="fixed inset-0 z-30 md:hidden" role="dialog" aria-modal="true" id="mobile-menu">
					...
					<div className="absolute right-0 top-0 h-full w-72 max-w-[80%] border-l border-zinc-800 bg-zinc-950 p-6 shadow-2xl">
						...
						<div className="mt-6">
							<button onClick={() => navigateTo('home')} className="inline-flex w-full items-center justify-center rounded-full bg-brand px-4 py-2 text-sm font-medium hover:bg-brand-dark">Get a quote</button>
						</div>
					</div>
				</div>
			)}
